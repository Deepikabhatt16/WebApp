    ...
    return (
      <>
        <Typography variant="h4" align="center" gutterBottom>
          Subject Details_____
        </Typography>
        <Typography variant="h6" gutterBottom>
          Subject Name : {subjectDetails && subjectDetails.subName}
        </Typography>
        <Typography variant="h6" gutterBottom>
          Day : {subjectDetails && subjectDetails.sessions}
        </Typography>
        <Typography variant="h6" gutterBottom>
          
          Starting Time : {subjectDetails && subjectDetails.start}
        </Typography>
        <Typography variant="h6" gutterBottom>
          
          Ending Time : {subjectDetails && subjectDetails.end}
        </Typography>
        <Typography variant="h6" gutterBottom>

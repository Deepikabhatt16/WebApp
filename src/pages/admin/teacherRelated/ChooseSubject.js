                    ...
                    <Table aria-label="sclasses table">
                        <TableHead>
                            <StyledTableRow>
                                ...
                                <StyledTableCell align="center">Ending</StyledTableCell>
                        ...
                        <TableBody>
                            {Array.isArray(subjectsList) && subjectsList.length > 0 && subjectsList.map((subject, index) => (
                                <StyledTableRow key={subject._id}>
                                    ...
                                    <StyledTableCell align="center">{subject.sessions}</StyledTableCell>
                                    <StyledTableCell align="center">{subject.start}</StyledTableCell>
                                    <StyledTableCell align="center">{subject.end}</StyledTableCell>
